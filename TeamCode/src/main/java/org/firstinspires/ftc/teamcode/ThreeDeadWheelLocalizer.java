...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -735.0537117395937; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 688.902701594634; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1231.2828224808477; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public ThreeDeadWheelLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d pose) {
        ...
        // forward test 인치로 181cm = 71inch
        //inter pick: 0.0029549475 kV: 0.0005926338407551701, kS: 0.9985866469300881
